...
| Version           | Type  | Russian                         | English                         | Name       |
| ----------------  | ----- | ------------------------------- | ------------------------------- | ---------- |
| `0.0.0-alpha.1`   | Start | Исправлены баги, изменен код    | Bugs fixed, changed code        | No |
| `0.1.0-alpha.1`   | Minor | Исправлены баги, код более читабелен, Добавлена новая функция создания 
голосовых каналов | Bugs fixed, the code is more readable, added a new function for creating voice channels | No |
