import { SlashCommandBuilder, EmbedBuilder, CommandInteraction, ChannelType } from 'discord.js';
...
/*             let channelGuildId = channel?.guildId;
            let channelGuild = channel?.guild;
            let channelGuildOwner = channel?.guild?.ownerId; */
